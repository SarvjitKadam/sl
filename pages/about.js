  ...
  return (
    <div style={{ marginTop: '2em' }}>
      <div className="jumbotron text-center">
        ...
        <h4>
          My program uses pre difined AI data model to generate the output from the given Input from Camera Actions.
        </h4>
      </div>
        ...
        <div className="row justify-content-center">
          ...
          <div className="col-xs-12 col-md-6">
            <p>
              ...
              output is our OpenCV pipeline.
              <br />
              It simply performs an adaptive threshold on a
